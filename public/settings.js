...
(function () {
  ...
  topbarBtn.className = 'px-2 py-1.5 rounded-xl border border-white/10 bg-white/5 text-slate-100 font-semibold text-sm inline-flex items-center gap-1.5 hover:-translate-y-px hover:bg-sky-400/15 hover:border-sky-400/80 transition-all';
  ...
  function syncVolumeUI() {
    const v = window.SFX ? SFX.getVolume() : parseFloat(localStorage.getItem('sp_sfx_volume') ?? '1');
