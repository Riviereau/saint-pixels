...
(function () {
  ...
  // Topbar button — inserted just before the right-side status chips
  ...
  topbarBtn.className = 'settings-topbar-btn';
  topbarBtn.innerHTML =
  ...
  // Insert into the header — before the right-side status group
